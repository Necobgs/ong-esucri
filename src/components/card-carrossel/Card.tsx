...
export default function Card(props:CardPropertyes) {
  return (
    <article className={`w-1/3 rounded-2xl h-140 bg-amber-100 flex items-center justify-start flex-col box-border p-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  ${props.className?? ''}`}>

...
export default function SlideProfession(props:ProfessionInterface){
    return (
        <article className="flex gap-5 items-start justify-start min-w-full pr-15 pl-15">
            <Image
                    src={props.image}
                    alt="Imagem"
                    width={800}
                    ...
                    priority
                />
                <div className="box-border  pl-15 pt-5 pb-5 w-1/2 flex flex-col gap-10 h-full">

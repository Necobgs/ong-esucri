    ...
    return (
        <>
            <section className="flex flex-col pl-40 pr-40 pt-10 gap-15 pb-10">
                <Image
                    src="/images/seja_voluntario.png"
                    alt="Imagem"
                    width={800}
                    height={200}
        ...
        <section className="pl-40 pr-40 pt-30 flex items-center flex-col justify-center gap-10 mb-20">
            ...
            <CardVolunteeringResult
                ...
                title="Dia de Conexão Digital"
                description="Para promover a inclusão digital e prática de informática com apoio de voluntários, foi realizado um mutirão com oficinas práticas onde os voluntários acompanharam os participantes em atividades como digitação, navegação na internet, criação de currículos e uso de aplicativos do dia a dia."
                direction="col"
            />
            <CardVolunteeringResult
                image="/images/evento2.png"
                title="Simulação com Apoio Voluntário"
                description="Foi simulado a rotina de um embalador em um supermecado parceiro, os voluntários atuaram como clientes e supervisores, ajudando os participantes a praticarem habilidades de atendimento, agilidade e organização."
                direction="col"
            />
            <CardVolunteeringResult
                image="/images/evento3.png"
                title="Aprendendo com Office Boys"
                description="Com apoio dos voluntários, os participantes simularam o dia a dia de um office boy: levar documentos, cumprir pequenas tarefas externas, aprender rotas e noções de trânsito seguro."
                direction="col"
            />
            <CardVolunteeringResult
                image="/images/evento4.png"
                title="Feira de Talentos e Inclusão Profissional"
                description="Para mostrar as habilidades desenvolvidas pelos participantes e conectar com empresas e a comunidade, foi realizado um evento com estandes dos projetos (informática, embalador, office boy), apresentações práticas e oportunidades de interação com empresários, familiares e voluntários."
                direction="row"
            />
            </div>
        </section>

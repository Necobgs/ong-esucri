    ...
    <>
       <section className="min-h-[100dvh] w-full flex flex-col justify-around pt-[5%] pl-[10%] pr-[10%]">
        <article className="flex justify-around items-center gap-[10%] w-full h-[80vh]">
            ...
            <h1 className="font-bold text-[64px] text-amber-400 ff-SourGummy-bold">
            ...
            <div className="flex justify-center items-center gap-6 text-white">
                <button className="bg-[#866AFF] p-3 rounded-3xl ff-SourGummy-bold">
        ...
        <section className="h-[60dvh] w-full bg-amber-400 flex items-center justify-center flex-row mt-10 mb-10 gap-20">
            <div className="text-center w-1/4 text-5xl rounded-t-full rounded-br-full bg-amber-200 h-3/4 flex items-center justify-center ff-SourGummy-bold">Frase motivadora</div>
            <div className="w-4/8">
                <h2 className="text-6xl mb-10 ff-SourGummy-bold">Sobre o instituto</h2>  
                <p className="text-1xl ff-NunitoSans">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce mi neque, finibus quis luctus sed, scelerisque id ante. In sagittis nec est vitae pellentesque. Suspendisse potenti. Aliquam massa libero, ullamcorper quis aliquam dignissim, tempus a massa. Cras sed sapien rhoncus, iaculis nunc lobortis, dapibus arcu.</p>
            </div>
        </section>
        <section className="w-full flex items-center justify-center flex-col gap-20 mt-20 mb-20">
            <h2 className="text-6xl ff-SourGummy-bold">Missão, Visão e Valores</h2>
            ...
            <span className="flex items-center justify-center flex-col gap-5">
                ...
                <button className="rounded-3xl bg-[#866AFF] pt-2 pb-2 pl-4 pr-4 text-white ff-SourGummy-bold">Quero conhecer</button>
            </span>

        </section>
        <section className="w-full bg-sky-300 flex items-center justify-center flex-col gap-20 p-20 box-border">
            <h2 className="text-6xl ff-SourGummy-bold">Nossos cursos</h2>
        ...
        <section className="w-full flex items-center justify-center flex-col p-20 box-border">
            <div className="w-full p-10 flex items-center justify-center flex-col mb-20">
                ...
                <h3 className="text-1xl text-center  ff-NunitoSans">Lorem ipsum dolor sit amet, consectetur</h3>
            </div>
            ...
            <p className="text-2xl text-wrap text-center mb-20 ff-SourGummy-bold">Lorem ipsum dolor sit amet, consectetur adipiscing<br/> elit. Fusce mi neque, finibus quis luctus sed, </p>
            <span className="mb-5 text-4xl ff-SourGummy-bold">Se torne um parceiro!</span>
            <button className="bg-black p-3 rounded-3xl text-white ff-SourGummy-bold">
                QUERO CONHECER!
            </button>
        </section>
        <section className="p-50 flex items-center justify-around bg-gray-200">
            <div className="flex flex-col items-center justify-center w-1/3">
                ...
                <button className="bg-black pt-3 pb-3 pl-4 pr-4 rounded-4xl text-white ff-SourGummy-bold text-2xl">
                    QUERO CONHECER!
                </button>
            </div>
            <div className="flex flex-col items-center justify-center w-1/3">
